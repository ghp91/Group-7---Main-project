...
<?php
		...
		$qget = "SELECT TOP 10 * FROM artikkel where a_typeID = 'konserter' order by artikkelID desc" ;
	    ...
	    <div class="sidebar_container">
		  ...
		  <div class="sidebar">
            <div class="sidebar_item">
              <h2>Siste saker:</h2>
			      <?php
        $sideqget  = "SELECT TOP 4 * FROM artikkel where a_typeID = 'konserter' order by artikkelID desc";
